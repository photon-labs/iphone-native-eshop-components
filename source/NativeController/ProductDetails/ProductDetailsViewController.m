...
-(void) loadOtherViews
{
	...
	if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
		...
		scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, SCREENWIDTH, 940)];
        ...
        UIImageView    *bgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 80, 768, 1200)];
        ...
        UIImageView    *bgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 40, SCREENWIDTH, 600)];
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
     ...
     //   [productImageView release];
        ...
        for (int i =0;i<[string intValue];i++) {
            ...
            starImage = [[UIImageView alloc] initWithFrame:CGRectMake(xStar,y,width, height)] ;
