...
-(UIView*) addBgView
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad) {
        ...
        view = [[UIView alloc] initWithFrame:CGRectMake(0, [[UIScreen mainScreen] applicationFrame].size.height - bgImage.frame.size.height + 9,bgImage.frame.size.width, bgImage.frame.size.height)];
