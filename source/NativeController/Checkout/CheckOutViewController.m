...
-(void) loadOtherViews
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
	{
       ...
       UILabel *myCartView = [[UILabel alloc] initWithFrame:CGRectMake(300, 100 , 180, 40)];
        ...
        UILabel *myCartView = [[UILabel alloc] initWithFrame:CGRectMake(120, 55 , 80, 20)];
...
-(void) initializeTableView
{
	if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
	{
        addToBagTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 180, 768, 550) style:UITableViewStylePlain];
    }
    else {
        addToBagTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 80, 320, 250) style:UITableViewStylePlain];
    }
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)
	{
        ...
        else if ((indexPath.section ==0) && (indexPath.row == 1))
        {
            if ((cell == nil) ||(cell != nil)) {
                ...
                UIButton *editView1 = (UIButton *)[cell viewWithTag:3];
                [editView1 addTarget:self action:@selector(editButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
